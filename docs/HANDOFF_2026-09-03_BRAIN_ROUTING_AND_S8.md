...
2. **"I'll list all parameters that need mod support when I'm home in front of screen."** (~21:5x)
   ...
   State: with it comes *"Every fader gets the same movement"* ⇒ **S7 is ONE universal slew law; the per-parameter curve table is dead before it was designed.**
...
- **Per-parameter slew curves — KILLED BY HIM 2026-09-03 ~21:5x** before any design existed: *"It doesnt matter. Every fader gets the same movement."*
