...
⭐ **THE SPHERICAL-HARMONIC MACHINERY ALREADY EXISTS.** `particles.metal:2470-2471` computes `dYdth`/`dYdphi`. It currently drives only the sculpt path, which is **default OFF** (bit16).
