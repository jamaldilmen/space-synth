...
**Commit at last verification:** `e853e18` (2026-08-18 18:26:03 — bumped from `13ac249` after the 2026-08-17/18 BH-march session; **scope: only the rows touched that session were re-verified at this sha**, the last full sweep remains the `13ac249` one) (**nothing committed since; all of 2026-08-11 and 2026-08-12 is uncommitted, now split across TWO trees — see the tree table**)
