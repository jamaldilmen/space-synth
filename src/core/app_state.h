...
struct AppState {
  ...
  bool  uiTogLensShadow   = false; // bit8 — back OFF (2026-07-18 02:52:10): turning it ON smeared the real particles into distorted "eye" arcs + hard rectangular blobs (Jamal's eyes) instead of a clean wrap — the lens DISPLACES particle screen positions rather than adding a lensed SECOND image while keeping the primary disk intact. Needs a primary+secondary rework, not a toggle. Clean two-ring look = bit8 OFF.
