...
//   frame(event) = startFrame + floor(t · fps)
// applied at the START of that frame, before the physics step — never early,
// at most one frame late, exact for every t. Two replays of one take are the
