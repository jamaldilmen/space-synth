...
- `[HIS WORDS]` 2026-09-03 ~21:5x: *"It doesnt matter. Every fader gets the same movement. I'll list all parameters that need mod support when I'm home in front of screen."* ⇒ **S7 is ONE universal slew law across every mapped fader — the per-parameter curve table is DEAD before it was designed.** His parameter list is pending and is HIS to write.
