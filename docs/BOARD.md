...
**Last verified against the code:** 2026-08-08 15:37:02
**Commit at last verification:** `4816056`
**Berlin New Media Week:** 2026-09-02 — **25 days out**
**Latest handoff:** `HANDOFF_2026-08-08_board_a1_fixed_n_measured.md`

> ⚠️ **UNCOMMITTED AND UNSEEN:** `src/main.cpp`, `renderer.h`, `renderer.mm` — the live-UI panel
> (§E5/§7 of the handoff). Held deliberately: **he has not looked at it.** The deployed bundle
> (2026-08-08 02:24:49) **does** contain it, along with the A1′ fix. Launch, do not rebuild.
